...
int main() {
  ...
  P.emplace_back(0, 2);                           // smallest
  P.emplace_back(1e-9, 1);                        // second smallest
  sort(P.begin(), P.end());
  ...
  P.clear();
  P.emplace_back(point(2, 2));
  P.emplace_back(point(4, 3));
  P.emplace_back(point(2, 4));
  P.emplace_back(6, 6);
  P.emplace_back(2, 6);
  P.emplace_back(point(6, 5));
  ...
  P.emplace_back(point(4, 3));
  P.emplace_back(point(2, 4));
  P.emplace_back(point(6, 6));
  P.emplace_back(point(2, 6));
  P.emplace_back(point(6, 5));
  P.emplace_back(point(8, 6));
  ...
  */
  ...
  printf("l2 & l4 are the same? %d\n",
         areSame(l2,
                 l4)); // yes, l2 (P[0]-P[2]) and l4 (P[2]-P[4]) are the same line (note, they are two different line segments, but same line)
  ...
  */
  ...
  printf("D = (%.2lf, %.2lf)\n", D.x, D.y);
  point E =
      translate(C, scale(v, 0.5)); // E will be located in coordinate (3.0 + 1/2 * 2.0, 2.0 + 1/2 * 1.0) = (4.0, 2.5)
  printf("E = (%.2lf, %.2lf)\n", E.x, E.y);
